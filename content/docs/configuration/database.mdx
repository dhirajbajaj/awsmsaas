...
This project use **Neon** on the free plan. Check their [pricing page](https://neon.tech/pricing) for more informations.
You can alternatively use other database providers like supabase etc.  
